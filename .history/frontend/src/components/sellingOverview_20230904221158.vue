...
<template>
    ...
    <div class="outer-container" v-if="items.length == 0">
        ...
        <div class="itempage-center">
            ...
            <!--filter Bids for their user id and whether won=True? but how do i know the auction has ended on that item yet. maybe instead
            of haviing field sold in Item, it should be in Bid? -->
        </div>
    </div>
</template>
