    ...
    <div class="outer-container">
        ...
        <div class="item-list">
            ...
            <div class="dropdown" @mouseover="showDropdown" @mouseleave="hideDropdown">
                <span> All items: </span>
                <p v-on:click="getAllActive"> ALL items: </p>
            ...
            <div v-if="dropdownList != -1" v-for="item in dropdownList" :key="item.id" class="user-item" @click="goToItemPage(item.id)">
            ...
            <div v-if="itemList != -1 && dropdownList.value != 0 " v-for="item in itemList" :key="item.id" class="user-item" @click="goToItemPage(item.id)">
                <img :src="item.picture" alt="picture" class="item-card-img" >
                <div class="item-listing">
                    <h2 class="item-title">{{ item.title }}</h2>
                    <p class="item-price">£{{ item.starting_price }}</p>
