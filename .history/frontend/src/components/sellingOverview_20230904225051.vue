...
<template>
    ...
    -->
    <div class="outer-container" v-if="purchasedItems.length > 0">
        <h2 class="page-title">My Bids:</h2>
        <!--keep history of all their bids, seperated by item-->
            <h3> My purchases: </h3>
            <!--how do i know they won? highest bidder when do i retrieve that? itempage? -->
            <!--item model has winner_id, is_sold=True(meaning auction ended), only thing i dont have is bid_price 
                but i can look for bid price in the Bid model => search for item with won=True? -->
            <div class="item-list">
