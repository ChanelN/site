...
import {BadHeaderError, send_mail} from django.core.mail ;
import {HttpResponse, HttpResponseRedirect} from django.http ;
...
setup() {
   ...
   //successful login
    ...
    onMounted(() => {
      //should implement cron jobs for detecting what auctions are over - and sending mail
      send_email();
    });
    ...
    const send_email = () =>{
      ...
      try{
        send_mail(subject, message, from_email, ["chanel.kim.ngo@gmail.com"]);
