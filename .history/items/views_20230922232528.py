...
# django.core.mail.BadHeaderError - here the from should be from admin
@csrf_exempt
@require_POST
def mailfunction(request):
    if request.method == "POST":
        #the data is being sent as JSON - using request.POST.get only works for FORM DATA
        ...
        if subject and message and from_email and recipient:
            ...
            return JsonResponse({'subject': subject, 'message':message, 'from_email': from_email, 'recipient':recipient}, status=400)
