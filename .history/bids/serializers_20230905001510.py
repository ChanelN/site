...
class BidSerializer(serializers.ModelSerializer):
    ...
    creator_readable = serializers.SerializerMethodField(source='creator')
    ...
    bidder_readable = serializers.SerializerMethodField(source='bidder')
    ...
    item_readable = serializers.SerializerMethodField(source='item')
